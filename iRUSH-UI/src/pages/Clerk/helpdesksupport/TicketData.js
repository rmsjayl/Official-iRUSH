...
const TicketData = () => {
  ...
  const [openRejectTicketModal, setOpenRejectTicketModal] = useState(false);
  const [openSubmitTicketModal, setOpenSubmitTicketModal] = useState(false);
  ...
  useEffect(() => {
    const fetchTicketData = async () => {
      setLoading(true);
      await instance
        .get(`/tickets/helpdesk/assignedtickets/${id}`)
        .then((response) => {
  ...
  const handleAssignTicket = async (e) => {
    ...
    try {
      await instance
        .post(`/tickets/helpdesk/assignedtickets/${id}`, reassignTicketData)
        .then((response) => {
  ...
  return (
    <>
      {openRejectTicketModal && (
        <RejectTicketModal modalOpen={setOpenRejectTicketModal} />
      )}

      {openSubmitTicketModal && (
        <SubmitTicketModal
          checkRole={userRole}
          modalOpen={setOpenSubmitTicketModal}
        />
      )}
                        ...
                        <div className={TICKETDATASTYLE["modal-btns__wrapper"]}>
                          ...
                          >
                            <Buttons
                              ...
                              onClick={() => setOpenRejectTicketModal(true)}
                            >
                              REJECT TICKET
                            </Buttons>
                          </div>
                          ...
                          <div
                            className={
                              TICKETDATASTYLE["modal-btn__submitticket"]
                            }
                          >
                            <Buttons
                              buttonSize="btn--medium"
                              buttonStyle="btn--primary__solid"
                              onClick={() => setOpenSubmitTicketModal(true)}
                            >
                              SUBMIT TICKET
                            </Buttons>
                          </div>
