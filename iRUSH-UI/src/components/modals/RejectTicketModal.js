...
const RejectTicketModal = ({ modalOpen }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await instance
        .post(
          `tickets/helpdesk/assignedtickets/rejectticket/${id}`,
          rejectTicketData
        )
        .then((response) => {
      ...
      if (error.response.status === 404) {
        toast.error("Error occured while rejecting the ticket.");
        navigate("/helpdesksupport/tickets");
      }
                  ...
                  <Box>
                    <FormControl fullWidth>
                      ...
                      <Select
                        ...
                        value={rejectTicketData.rejectReason}
                ...
                <div className={CONFIRMMODALSTYLE["name-setting__input"]}>
                  <Box component="form">
                    <TextField
                      ...
                      value={rejectTicketData.remarks}
