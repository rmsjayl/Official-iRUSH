          ...
          <div className={USERHEADERSTYLE["header-container__details"]}>
            {user.map((user, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={USERHEADERSTYLE["header-clerkName__container"]}
                  >
                    {user.name}
                  </div>
                  <div
                    className={USERHEADERSTYLE["header-clerkEmail__container"]}
                  >
                    {user.email}
                  </div>
                  <div
                    className={USERHEADERSTYLE["header-clerkRole__container"]}
                  >
